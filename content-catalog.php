	...
	<div id="content">
		...
		<main class="">
			<div class="title-wrap d-flex flex-wrap align-items-center">
				<h1 class="flex-grow-1">Блоки слайдера</h1>
				<div class="main-header-buttons">
					<a href="#" class="btn btn-blue">Добавить блок</a>
				</div>
			</div>
			<div id="main-content">

				<ul class="nav tabs-line" id="slider-tabs" role="tablist">
					<li class="nav-item">
				...
				<div class="tab-content" id="slider-tabs-content">
						...
						<div class="row">
							<div class="col-lg-3 d-lg-block filter-pane">
								...
								<div class="filter-form">
									...
									<form class="kform">
										<div>
											<label for="title">Наименование блока</label>
											<input type="text" id="title" class="form-control" placeholder="Наименование блока">
										</div>
										<div>
										...
										<table class="table table-hover table-users table-sortable">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="">Извещение о мероприятии</a>
													</td>
